...
export type SetArchiveStatusMutationVariables = Exact<{
  id: Scalars['ID']['input'];
  archived: Scalars['Boolean']['input'];
}>;


export type SetArchiveStatusMutation = { __typename?: 'Mutation', setLinkArchived: { __typename?: 'ArchiveLinkError', message: string, errorCodes: Array<ArchiveLinkErrorCode> } | { __typename?: 'ArchiveLinkSuccess', linkId: string, message: string } };

export type CreateArticleSavingRequestMutationVariables = Exact<{
  input: CreateArticleSavingRequestInput;
}>;


export type CreateArticleSavingRequestMutation = { __typename?: 'Mutation', createArticleSavingRequest: { __typename?: 'CreateArticleSavingRequestError', errorCodes: Array<CreateArticleSavingRequestErrorCode> } | { __typename?: 'CreateArticleSavingRequestSuccess', articleSavingRequest: { __typename?: 'ArticleSavingRequest', id: string, status: ArticleSavingRequestStatus } } };

export type SetLabelsMutationVariables = Exact<{
  pageId: Scalars['ID']['input'];
  labelIds?: InputMaybe<Array<Scalars['ID']['input']> | Scalars['ID']['input']>;
  labels?: InputMaybe<Array<CreateLabelInput> | CreateLabelInput>;
}>;


export type SetLabelsMutation = { __typename?: 'Mutation', setLabels: { __typename?: 'SetLabelsError', errorCodes: Array<SetLabelsErrorCode> } | { __typename?: 'SetLabelsSuccess', labels: Array<{ __typename?: 'Label', id: string, name: string, color: string, description?: string | null }> } };
...
export type MeQuery = { __typename?: 'Query', me?: { __typename?: 'User', id: string, name: string, isFullUser?: boolean | null, picture?: string | null, profile: { __typename?: 'Profile', id: string, username: string, private: boolean, pictureUrl?: string | null } } | null };


export const SetArchiveStatusDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"SetArchiveStatus"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"archived"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Boolean"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"setLinkArchived"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"linkId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}},{"kind":"ObjectField","name":{"kind":"Name","value":"archived"},"value":{"kind":"Variable","name":{"kind":"Name","value":"archived"}}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ArchiveLinkError"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"message"}},{"kind":"Field","name":{"kind":"Name","value":"errorCodes"}}]}},{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"ArchiveLinkSuccess"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"linkId"}},{"kind":"Field","name":{"kind":"Name","value":"message"}}]}}]}}]}}]} as unknown as DocumentNode<SetArchiveStatusMutation, SetArchiveStatusMutationVariables>;
